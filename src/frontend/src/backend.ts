...
export class Backend implements backendInterface {
    ...
    async addAppointment(arg0: string, arg1: string, arg2: string, arg3: Time, arg4: string): Promise<AppointmentId> {
        if (this.processError) {
            try {
                const result = await this.actor.addAppointment(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addTestimonial(arg0: string, arg1: number, arg2: string): Promise<void> {
        if (this.processError) {
            try {
